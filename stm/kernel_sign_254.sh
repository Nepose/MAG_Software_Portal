...
./mkimage -A sh -O linux -T kernel -C gzip -a 0x80800000 -e $entrypoint -n "MAG${MODEL_NUMBER} SH4 Kernel Linux 2.6.17" -d ./vmlinux.sign ./uImage_mag${MODEL_NUMBER}
