...
then
	...
	echo "[ ${OutputGreen}OK!${OutputWhite} ] Doing image of kernel with custom key."
fi

export MODEL_NUMBER=324
...
./writebb_util -o ./uImzlib_null_mag${MODEL_NUMBER}.img ./uImage_mag${MODEL_NUMBER}
